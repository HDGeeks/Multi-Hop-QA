...
# # src/scoring/bertscore_scoring_v2.py
# """
# BERTScore scoring (v2) with percent outputs for paper tables.

# Outputs written to <outdir>:
#   - <model>_bertscore_per_run_v2.csv
#       columns include: bertscore_f1  (0–1), bertscore_f1_percent (0–100)
#   - <model>_bertscore_aggregated_items_v2.csv  (wide per qid)
#       columns include (0–1):   bertscore_gold, bertscore_para, bertscore_dist, bertscore_para_dist
#                    and (0–100) bertscore_*_percent mirrors
#                    and drops in pp: drop_bertscore_*_pp
#   - <model>_bertscore_by_domain_v2.csv
#       columns include (0–1):   bertscore_gold_median, bertscore_dist_median
#                    and (0–100) *_percent mirrors
#                    and drop_dist_pp_median (pp)
#   - <model>_bertscore_summary_v2.json
#       stores medians by setting in percent and median drops in pp
# """
